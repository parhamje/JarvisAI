...
class MetricBar(QWidget):
    ...
    def paintEvent(self, _):
        ...
        grad.setColorAt(0, qcol("#010d18"))
        grad.setColorAt(1, qcol("#000810"))
        ...
        if fill_w > 0:
            ...
            # subtle glow
            p.setBrush(QBrush(qcol(bar_col.name(), 60)))
            p.drawRoundedRect(QRectF(bar_x, bar_y - 1, fill_w + 2, bar_h + 2), 2, 2)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("J.A.R.V.I.S — Parham's Personal AI")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("Parham Industries  ·  J.A.R.V.I.S  ·  CLASSIFIED"))
        lay.addStretch()
        return w
